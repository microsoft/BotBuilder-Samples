...
|2.EchoBot-With-Counter|Demonstrates how to use state. Shows commented out code for all natively supported storage providers. Storage providers should include InMemory, CosmosDB and Blob storage. Default bot template for ABS, VSIX, Generators and dotnet new template|[View Sample](csharp_dotnetcore/1.console-echobot)[![Deploy to Azure][Deploy Button]][Deploy csharp_dotnetcore/2.echobot-with-counter]|[View Sample](csharp_dotnetcore/1.console-echobot)[![Deploy to Azure][Deploy Button]][Deploy csharp_webapi/2.echobot-with-counter]|[View Sample](csharp_dotnetcore/1.console-echobot)[![Deploy to Azure][Deploy Button]][Deploy javascript_nodejs/2.echobot-with-counter]|[View Sample](csharp_dotnetcore/1.console-echobot)[![Deploy to Azure][Deploy Button]][Deploy javascript_ts/2.echobot-with-counter]|

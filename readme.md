...
|-----------|-----------|---------|------------|--------|--|
|1.Console-EchoBot|Introduces the concept of adapter and demonstrates a simple echo bot on console adapter and how to send a reply and access the incoming the incoming message. Doc topic from readme lists other adapter types|[View Sample](csharp_dotnetcore/1.console-echobot)[![Deploy to Azure][Deploy Button]][Deploy csharp_dotnetcore/1.console-echobot]||[View Sample](javascript_nodejs/1.console-echobot)[![Deploy to Azure][Deploy Button]][Deploy javascript_nodejs/1.console-echobot]||

This sample demonstrates a simple echo bot with state with ASP.Net Web API. The bot maintains a simple counter that increases with each message from the user.
...
```
- [Optional] Update the `appsettings.json` file under `botbuilder-samples/samples/csharp_webapi/02.b.echo-with-counter` with your botFileSecret.  For Azure Bot Service bots, you can find the botFileSecret under application settings.

...
upload files to Teams from a bot and how to receive a file sent to a bot as an attachment, can be found [here](https://github.com/OfficeDev/Microsoft-Teams-Samples/tree/main/samples/bot-file-upload/python)**

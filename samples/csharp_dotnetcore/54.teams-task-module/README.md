...
This bot has been created using [Bot Framework](https://dev.botframework.com), it shows how to create a simple bot that accepts requests to fetch task modules.
...
- In a terminal, navigate to `samples/csharp_dotnetcore/54.teams-task-module`

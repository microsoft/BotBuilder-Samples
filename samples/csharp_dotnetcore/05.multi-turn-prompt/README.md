...
included in the [adaptive-dialogs](https://docs.microsoft.com/en-us/azure/bot-service/bot-builder-concept-dialog?view=azure-bot-service-4.0) library
and supported by the SDK.

The `adaptive-dialogs` library includes a variety of pre-built prompt classes, including text, number, and datetime types. This
sample demonstrates using a text input prompt to collect the user's name, then using a number input prompt to collect an age, and an Attachment input prompt to collect a profile picture.

...
Bot Framework v4 multi-turn prompt bot sample. This sample demonstrates using [language generation][1] to achieve multi-turn prompt bot. 
...
- In a terminal, navigate to `samples/csharp_dotnetcore/adaptive-dialog/05.multi-turn-prompt-with-language-fallback`
- Run the bot from a terminal or from Visual Studio, choose option A or B.
  ...
  - Navigate to `samples/csharp_dotnetcore/adaptive-dialog/05.multi-turn-prompt-with-language-fallback` folder

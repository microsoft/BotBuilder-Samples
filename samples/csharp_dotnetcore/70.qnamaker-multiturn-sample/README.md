...
Bot Framework v4 QnA Maker Multiturn bot sample. This sample shows how to integrate multiturn in a bot with ASP.Net Core-2. Click [here][72] to know more about using follow-up prompts to create multiturn conversation.
...
- In a terminal, navigate to `samples/csharp_dotnetcore/58.qnamaker-multiturn-sample`
- Run the bot from a terminal or from Visual Studio, choose option A or B.
  ...
  - Navigate to `samples/csharp_dotnetcore/58.qnamaker-multiturn-sample` folder
  - Select `QnAMultiturnBot.csproj` file

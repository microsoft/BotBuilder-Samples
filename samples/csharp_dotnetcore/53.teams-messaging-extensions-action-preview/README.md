...
Bot Framework v4 Teams Messaging Extensions Action Preview sample.
...
- In a terminal, navigate to `samples/csharp_dotnetcore/53.teams-messaging-extensions-action-preview`

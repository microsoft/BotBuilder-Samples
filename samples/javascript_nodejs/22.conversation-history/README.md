...
- Clone the repository
    ...
    ```
- In a terminal, navigate to `samples/javascript_nodejs/22.conversation-history`
    ```bash
    cd samples/javascript_nodejs/22.conversation-history
    ```
...
- Update [`conversation-history.bot`](conversation-history.bot) with your `connectionString` for Blob service. 
...
- Navigate to `samples/javascript_nodejs/22.conversation-history` folder
- Select `conversation-history.bot` file
...
[41]: ./PREREQUISITES.md
[42]: https://azure.microsoft.com/free/

...
const { ConversationHistoryBot } = require('./bot');
...
// Name of Blob Type service within the .bot file
const BLOB_CONFIGURATION = 'BlobStorage';
...
//NOTE: This example does not use state, but does use transcript middleware.
//      This bot has no state requirements.
...
const bot = new ConversationHistoryBot(transcriptStore);
...
server.listen(process.env.port || process.env.PORT || 3978, function() {
    ...
    console.log(`\nTo talk to your bot, open conversation-history.bot file in the Emulator`);
});

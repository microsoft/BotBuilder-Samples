...
When [designing the user experience][Design the user experience] developers should consider adding visual elements such as Rich Cards.
...
- [Design the user experience][Design the user experience]

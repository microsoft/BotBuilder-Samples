# loggerBot
This bot demonstrates the transcript logging middleware in the nodejs SDK. The files `CustomLogger.js` contain a custom implementation of the logging middleware.

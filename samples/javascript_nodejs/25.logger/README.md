...
This bot has been created using [Microsoft Bot Framework][1], it shows how to create a bot that demonstrates how to store transcript logs of the conversation. The file `customLogger.js` contains a custom implementation of the logging middleware.
...
- Navigate to `samples/javascript_nodejs/25.logger-bot` folder

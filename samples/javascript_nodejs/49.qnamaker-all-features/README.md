...
- Update [.env](.env) with your kbid (KnowledgeBase Id), endpointKey, endpointHost and defaultAnswer. QnA knowledge base setup and application configuration steps can be found [here](https://aka.ms/qna-instructions).

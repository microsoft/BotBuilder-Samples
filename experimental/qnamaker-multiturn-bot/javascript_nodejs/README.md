...
This sample shows how to integrate Multiturn and Active learning in a QnA Maker bot in NodeJS. Click [here][51] to know more about using follow-up prompts to create multiturn conversation. To know more about how to enable and use active learning, click [here][50].

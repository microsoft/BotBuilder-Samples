...
Bot Framework v4 Subcribe to bot events sample for Teams.
...
## Interacting with the bot
    ...
    - Bot will send a Welcome message with the logged in User name upon adding the app.
    - Post respective messages in the General channel of a Team when any channel is created, renamed, deleted or in case of Team rename as well.
    - A message will be posted in the General channel, welcoming the members being added, removed.
    - Reply message would be posted upon the reaction addition/removal.

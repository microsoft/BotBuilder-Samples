...
namespace QnAMakerActiveLearningBot
{
    ...
    public class QnAMakerActiveLearningBot : IBot
    {
        ...
        private QnAMakerDialogOptions _qnaMakerDialogOptions;
        ...
        public QnAMakerActiveLearningBot(BotServices services, BotAccessors accessors)
        {
            ...
            _qnaMakerDialogOptions = new QnAMakerDialogOptions
            {
                Top = 3,
                Threshold = 10
            };
            ...
            if (turnContext.Activity.Type == ActivityTypes.Message)
            {
                ...
                switch (results.Status)
                {
                    ...
                    case DialogTurnStatus.Empty:
                        await dialogContext.BeginDialogAsync(_dialogHelper.ActiveLearningDialogName, _qnaMakerDialogOptions, cancellationToken);
                        break;

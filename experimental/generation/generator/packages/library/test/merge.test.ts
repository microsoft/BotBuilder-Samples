...
describe('dialog:generate --merge library', async function () {
    ...
    it('merge: modified', async function () {
        try {
            ...
            await assertContains('language-generation/en-us/Bread/sandwichMerge-BreadValue.en-us.lg', /black/, errors)
            await assertContains('language-understanding/en-us/Bread/sandwichMerge-Bread-BreadValue.en-us.lu', /black/, errors)
            await assertMissing('language-generation/en-us/Bread/sandwichMerge-BreadValue.en-us.lg', /white/, errors)
            //sandwichMerge
            await assertMissing('language-understanding/en-us/Bread/sandwichMerge-Bread-BreadValue.en-us.lu', /white/, errors)
            await assertContains('language-generation/en-us/Cheese/sandwichMerge-CheeseValue.en-us.lg', /brie/, errors)
            ...
            await assertUnchanged('language-generation/en-us/Bread/sandwichMerge-BreadValue.en-us.lg', false, errors)
    ...
    it('merge: respect changes', async function () {
        try {
            ...
            await assertUnchanged('language-generation/en-us/Cheese/sandwichMerge-CheeseValue.en-us.lg', false, errors)

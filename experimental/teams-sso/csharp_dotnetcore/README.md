...
Bot Framework v4 bot using Teams SSO authentication.

> See [SSOSetup.md](./SSOSetup.md) for Teams SSO configuration instructions.
...
- Navigate to `experimental/teams-sso/teams-sso/csharp_dotnetcore` folder

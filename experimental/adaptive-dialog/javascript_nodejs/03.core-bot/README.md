...
This sample demonstrates using [Adaptive dialog (JS-PREVIEW)][1] and [Language Generation][2] features to achieve the same functionality that the waterfall based core bot sample [here][3].
...
[3]:../../../samples/javascript_nodejs/13.core-bot

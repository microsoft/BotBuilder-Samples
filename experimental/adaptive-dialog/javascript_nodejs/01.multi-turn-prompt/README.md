...
This sample demonstrates using [Adaptive dialog (JS-PREVIEW)][1] and [Language Generation][2] features to achieve the same functionality that the waterfall based multi-turn-prompt sample [here][3].

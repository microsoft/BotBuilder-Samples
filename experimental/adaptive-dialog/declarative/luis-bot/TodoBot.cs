...
//
// Generated with Bot Builder V4 SDK Template for Visual Studio Todo bot v4.3.0
...
{
    public class TodoBotWithLUIS : ActivityHandler
    {
        private IStatePropertyAccessor<DialogState> dialogStateAccessor;
        private AdaptiveDialog rootDialog;
        private readonly ResourceExplorer resourceExplorer;

        public TodoBotWithLUIS(ConversationState conversationState, ResourceExplorer resourceExplorer)
        {

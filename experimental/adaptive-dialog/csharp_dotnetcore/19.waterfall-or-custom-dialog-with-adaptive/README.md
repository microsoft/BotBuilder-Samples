...
## List of changes done to 19.custom-dialogs bot
...
4. Update adapter to use storage as well as conversation, user state.
5. Define adaptive dialog, add it to the component.

Mix and match adaptive/ waterfall/ custom dialogs as you see fit.

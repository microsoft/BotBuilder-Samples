...
exports.buildInfunctionsMap = exports.FunctionEntity = void 0;
...
exports.buildInfunctionsMap = new Map([
    ...
    ['empty', new FunctionEntity(['collection: any'], adaptive_expressions_1.ReturnType.Boolean, 'Check if the target is empty.')],
    ...
    [
        'split',
        new FunctionEntity(['text: string', 'delimiter: string'], adaptive_expressions_1.ReturnType.Array, 'Returns an array that contains substrings based on the delimiter specified.'),
    ],
    [
        'substring',
    ...
    [
        'foreach',
        new FunctionEntity(['collection: Array | Object', 'iteratorName: string', 'function: any'], adaptive_expressions_1.ReturnType.Array, 'Operate on each element and return the new collection'),
    ],
    [
        'addDays',
    ...
    ['createArray', new FunctionEntity(['...objects: any[]'], adaptive_expressions_1.ReturnType.Array, 'Create an array from multiple inputs')],
    [
        'if',
    ...
    [
        'json',
        new FunctionEntity(['value: string|XML'], adaptive_expressions_1.ReturnType.Object, 'Return the JavaScript Object Notation (JSON) type value or object for a string or XML.'),
    ],
    [
        'getProperty',
    ...
    [
        'union',
        new FunctionEntity(['...values: Array[]'], adaptive_expressions_1.ReturnType.Array, 'Produces the set union of two sequences by using the default equality comparer.'),
    ],
    [
        'intersection',
        new FunctionEntity(['...values: Array[]'], adaptive_expressions_1.ReturnType.Array, ' Produces the set intersection of two sequences by using the default equality comparer to compare values.'),
    ],
    [
        'skip',
        new FunctionEntity(['array: Array', 'length: number'], adaptive_expressions_1.ReturnType.Array, 'Bypasses a specified number of elements in a sequence and then returns the remaining elements.'),
    ],
    [
        'take',
        new FunctionEntity(['array: Array', 'length: number'], adaptive_expressions_1.ReturnType.Array, 'Returns a specified number of contiguous elements from the start of a sequence.'),
    ],
    [
        'subArray',
        new FunctionEntity(['array: Array', 'startIndex: number', 'endIndex: number'], adaptive_expressions_1.ReturnType.Array, 'Returns the sub array from start index to end index'),
    ],
    ['binary', new FunctionEntity(['value: string'], adaptive_expressions_1.ReturnType.Object, 'Return the binary version for an input value.')],
    [
        'dataUri',
    ...
    [
        'dataUriToBinary',
        new FunctionEntity(['value: string'], adaptive_expressions_1.ReturnType.Boolean, 'Return the binary version for a data uniform resource identifier (URI). Use this function rather than decodeDataUri(). Although both functions work the same way, dataUriBinary() is preferred.'),
    ],
    [
        'dataUriToString',
    ...
    [
        'base64ToBinary',
        new FunctionEntity(['value: string'], adaptive_expressions_1.ReturnType.Object, 'Return the binary version for a base64-encoded string.'),
    ],
    [
        'base64ToString',
    ...
    [
        'range',
        new FunctionEntity(['startIndex: number', 'count: number'], adaptive_expressions_1.ReturnType.Array, 'Return an integer array that starts from a specified integer.'),
    ],
    [
        'getFutureTime',
    ...
    */
    ...
    [
        'where',
        new FunctionEntity(['collection: Array | Object', 'iteratorName: string', 'confitionFunction: any'], adaptive_expressions_1.ReturnType.Array, 'Filter on each element and return the new collection of filtered elements which match specific condition'),
    ],
    [
        'sortBy',
        new FunctionEntity(['collection: Array', 'property: string'], adaptive_expressions_1.ReturnType.Array, 'Sort elements in the collection with ascending order and return the sorted collection.'),
    ],
    [
        'sortByDescending',
        new FunctionEntity(['collection: Array', 'property: string'], adaptive_expressions_1.ReturnType.Array, 'Sort elements in the collection with descending order and return the sorted collection.'),
    ],
    [
        'indicesAndValues',
        new FunctionEntity(['collection: Array'], adaptive_expressions_1.ReturnType.Array, 'Turned an array into an array of objects with index (current index) and value property.'),
    ],
    [
        'jPath',
    ...
    [
        'isMatch',
        new FunctionEntity(['targetString: string', 'pattern: string'], adaptive_expressions_1.ReturnType.Boolean, 'test a given string ia match a common regex pattern.'),
    ],
    //type checing functions
    [
        'isInteger',
        new FunctionEntity(['input: any'], adaptive_expressions_1.ReturnType.Boolean, 'determine whether a given input is an integer number.'),
    ],
    [
        'isFloat',
        new FunctionEntity(['input: any'], adaptive_expressions_1.ReturnType.Boolean, 'determine whether a given input is a float point number.'),
    ],
    [
        'isBoolean',
        new FunctionEntity(['input: any'], adaptive_expressions_1.ReturnType.Boolean, 'determine whether a given input is a boolean.'),
    ],
    ['isArray', new FunctionEntity(['input: any'], adaptive_expressions_1.ReturnType.Boolean, 'determine whether a given input is an array.')],
    ['isObject', new FunctionEntity(['input: any'], adaptive_expressions_1.ReturnType.Boolean, 'determine whether a given input is an object.')],
    [
        'isDateTime',
        new FunctionEntity(['input: any'], adaptive_expressions_1.ReturnType.Boolean, 'determine whether a given input is a UTC ISO format timestamp.'),
    ],
    ['isString', new FunctionEntity(['input: any'], adaptive_expressions_1.ReturnType.Boolean, 'determine whether a given input is a string.')],
    ['formatEpoch', new FunctionEntity(['epoch: number', 'format?: string'], adaptive_expressions_1.ReturnType.String, 'Return a timestamp from UNIX Epoch time (Unix time, POSIX time).')],
    ['formatTicks', new FunctionEntity(['ticks: number', 'format?: string'], adaptive_expressions_1.ReturnType.String, 'Return a timestamp from ticks.')],
    ['isPresent', new FunctionEntity(['timex: TimexProperty|string'], adaptive_expressions_1.ReturnType.Boolean, 'Return true if the TimexProperty or Timex expression refers to the present.')],
    ['isDuration', new FunctionEntity(['timex: TimexProperty|string'], adaptive_expressions_1.ReturnType.Boolean, 'Return true if the TimexProperty or Timex expression refers to a duration.')],
    ['isTime', new FunctionEntity(['timex: TimexProperty|string'], adaptive_expressions_1.ReturnType.Boolean, 'Return true if the TimexProperty or Timex expression refers to a time.')],
    ['isDate', new FunctionEntity(['timex: TimexProperty|string'], adaptive_expressions_1.ReturnType.Boolean, 'Return true if the TimexProperty or Timex expression refers to a date.')],
    ['isTimeRange', new FunctionEntity(['timex: TimexProperty|string'], adaptive_expressions_1.ReturnType.Boolean, 'Return true if the TimexProperty or Timex expression refers to a time range.')],
    ['isDateRange', new FunctionEntity(['timex: TimexProperty|string'], adaptive_expressions_1.ReturnType.Boolean, 'Return true if the TimexProperty or Timex expression refers to a date range.')],
    ['isDefinite', new FunctionEntity(['timex: TimexProperty|string'], adaptive_expressions_1.ReturnType.Boolean, '	Return true if the TimexProperty or Timex expression refers to a definite day.')],
    ...
    [
        'ActivityAttachment',
        new FunctionEntity(['content: Object', 'type: string'], adaptive_expressions_1.ReturnType.Object, 'Return an activityAttachment constructed from an object and a type.'),
    ],
]);

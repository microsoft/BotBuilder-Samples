...
```
- [Optional] Update the `appsettings.json` file under `BotBuilder-Samples\solutions\csharp_dotnetcore\02.Basic-Bot` with your botFileSecret.  
...
Navigate to sample:
`cd BotBuilder-Samples\solutions\csharp_dotnetcore\03.Basic-Bot`
...
- Navigate to [LUIS portal](https://www.luis.ai).
- Click the `Sign in` button.
- Click on the `Choose File` and select [basic-bot.luis](basic-bot.luis) from the `BotBuilder-Samples\solutions\csharp_dotnetcore\03.Basic-Bot\CognitiveModels` folder.
...
## Visual Studio
- Navigate to the samples folder (`BotBuilder-Samples\solutions\csharp_dotnetcore\03.Basic-Bot`) and open `BasicBot.csproj` in Visual Studio.
- Press F5.
## Visual Studio Code
- Open `BotBuilder-Samples\solutions\csharp_dotnetcore\03.Basic-Bot` sample folder.
- Bring up a terminal, navigate to `BotBuilder-Samples\solutions\csharp_dotnetcore\03.Basic-Bot` folder.
- Type 'dotnet run'.
...
- File -> Open bot and navigate to `BotBuilder-Samples\solutions\csharp_dotnetcore\03.Basic-Bot` folder

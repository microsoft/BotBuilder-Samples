...
```
- [Optional] Update the `appsettings.json` file under `botbuilder-samples\solutions\csharp_dotnetcore\01.echo-bot` with your botFileSecret.  For Azure Bot Service bots, you can find the botFileSecret under application settings.
# Prerequisites
## Visual Studio
- Navigate to the samples folder (`botbuilder-samples\solutions\csharp_dotnetcore\01.echo-bot`) and open EchoBotWithCounter.csproj in Visual Studio.
- Hit F5.

## Visual Studio Code
- Open `botbuilder-samples\solutions\csharp_dotnetcore\01.echo-bot` sample folder.
- Bring up a terminal, navigate to `botbuilder-samples\solutions\csharp_dotnetcore\01.echo-bot` folder.
- Type 'dotnet run'.
...
- File -> Open bot and navigate to `botbuilder-samples\solutions\csharp_dotnetcore\01.echo-bot` folder.

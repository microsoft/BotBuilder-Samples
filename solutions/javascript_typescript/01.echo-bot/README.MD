...
- In a terminal, 
    ```bash
    cd solutions/javascript_typescript/02.echo-bot
    ```
- [Optional] Update the .env file under solutions/javascript_typescript/02.echo-bot with your botFileSecret
...
- File -> Open Bot Configuration and navigate to solutions\javascript_typescript\02.echo-bot folder

module.exports = function () {
    ...
    global.indexName = process.env.INDEX_NAME ? process.env.INDEX_NAME : "<YourIndexName>";
    global.searchKey = process.env.AZURE_SEARCH_KEY ? process.env.AZURE_SEARCH_KEY : "<YourSearchKey>";

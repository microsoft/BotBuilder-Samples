This sample shows how to integrate QnA Maker in a simple bot with ASP.Net Web API and Application Insights. 
...
## Visual studio
- Navigate to the samples folder (`BotBuilder-Samples\csharp_webapi\11.QnAMaker`) and open AspNetCore-QnA-Bot.csproj in Visual studio 
- Hit F5

...
Newsie | A sample bot that finds news using Bing News Search API and summarize news articles using Bing Summarizer API. | [View Sample](/CSharp/intelligence-Newsie)[![Deploy to Azure][Deploy Button]][Deploy CSharp/Newsie] | [View Sample](/Node/intelligence-Newsie)[![Deploy to Azure][Deploy Button]][Deploy Node/Newsie]

...
Basic Multi Dialogs | A sample bot showing how to use the dialog stack. | [View Sample](/CSharp/core-BasicMultiDialog) | [View Sample](/Node/core-basicMultiDialog)[![Deploy to Azure][Deploy Button]][Deploy Node/BasicMultiDialog]
...
Global Message Handlers | A sample bot showing the usage of Global Message Handlers to handle global commands and manipulate the dialog stack. | [View Sample](/CSharp/core-GlobalMessageHandlers) | [View Sample](/Node/core-globalMessageHandlers)[![Deploy to Azure][Deploy Button]][Deploy Node/GlobalMessageHandlers]
...
Knowledge Bot | A sample that uses Azure Document DB and Azure Search that searches and filters over an underlying dataset. | [View Sample](/CSharp/sample-KnowledgeBot) | [View Sample](/Node/sample-knowledgeBot)

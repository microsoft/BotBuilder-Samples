...
# Configure services
This sample relies on [LUIS](http://luis.ai), [QnA Maker](http://qnamaker.ai) and [Dispatch](http://github.com/microsoft/botbuilder-tools//tree/master/packages/Dispatch) services. 

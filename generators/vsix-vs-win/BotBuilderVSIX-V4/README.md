# Bot Builder V4 SDK Templates
The Bot Builder V4 SDK Templates are available for .NET, and will let you quickly set up a conversational AI bot
using core AI capabilities. They are available as a [VSIX][1] package.

# About
Bot Builder V4 SDK Templates will help you build new conversational AI bots using the [Microsoft Bot Framework v4][2].
...
### Empty Template
The Empty bot is your classic "Hello World" bot. This template shows the basic structure of a bot, how a bot receives, messages from a user, and how a bot sends a message to a user. The bot always responds "Hello World" whenever the user sends a message. It is good for advanced bot builders who want a bare skeleton to implement their code.

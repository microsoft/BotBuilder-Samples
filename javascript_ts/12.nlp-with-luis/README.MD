...
- Clone the repository
    ...
    ```
- In a console, navigate to javascript_ts\12.nlp-with-luis
    ```bash
    cd javascript_ts\12.nlp-with-luis
    ```
...
- File -> Open Bot Configuration and navigate to javascript_ts\12.nlp-with-luis folder
...
- Click on the `Choose File` and select [Reminders.json](cognitiveModels/Reminders.json) from the `BotBuilder-Samples\javascript_ts\12.nlp-with-luis\cognitiveModels` folder.

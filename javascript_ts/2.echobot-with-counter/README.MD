This sample shows how to create a simple echo bot with state. The bot keeps simple counter step that increases with each user message. This bot example uses [`restify`](https://www.npmjs.com/package/restify). 

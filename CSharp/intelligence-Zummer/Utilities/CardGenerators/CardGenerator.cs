...
namespace Zummer.Utilities.CardGenerators
{
    ...
    {
        public static Attachment GetThumbNailCard(string title = default(string), string subtitle = default(string), string text = default(string),  List<CardAction> cardActions = null, CardAction cardTap = null, CardImage cardImage = null)
        {

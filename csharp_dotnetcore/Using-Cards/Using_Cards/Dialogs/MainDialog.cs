...
namespace Using_Cards.Dialogs
{
    public class MainDialog : ComponentDialog
    {
        ...
        {
            AddDialog(new WaterfallDialog("cardSelector", new WaterfallStep[]{ ChoiceCardStep, ShowCardStep }));
        ...
        private static async Task<DialogTurnResult> ShowCardStep(DialogContext dc, WaterfallStepContext step, CancellationToken cancellationToken)
        {
            ...
            await dc.Context.SendActivityAsync("Type anything to cheese another card.", cancellationToken: cancellationToken);

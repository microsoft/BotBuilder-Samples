...
```
- [Optional] Update the `appsettings.json` file under `BotBuilder-Samples\csharp_dotnetcore\02.EchoBot-With-Counter` with your botFileSecret.  For Asure Bot Service bots, you can find the botFileSecret under application settings.
- 
# Prerequisites
## Visual Studio

...
namespace Handling_Atachments
{
    ...
    public class Startup
    {
        ...
        /// For more information on how to configure your application, visit <see cref="https://docs.microsoft.com/en-us/aspnet/core/fundamentals/startup"/>.
        /// </summary>
        ...
        {
            services.AddBot<AtachmentsBot>(options =>
            {
